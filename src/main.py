...
class ConsoleFrame(ttk.Frame):
    ...
    def __init__(self, root):
        ...
        self.text_console.log("Click a button to run a test :-)" + os.linesep)
...
class AppicationFrame(ttk.Frame):
    ...
    def setup_ui(self):
        ...
        button_one = ttk.Button(toolbar, text="BSearch 1", command=self.on_one_clicked)
        button_one.pack(side=LEFT, padx=2)
        button_two = ttk.Button(toolbar, text="BSearch 2", command=self.on_two_clicked)
        button_two.pack(side=LEFT, padx=2)
        button_three = ttk.Button(toolbar, text="BSearch 3", command=self.on_three_clicked)
